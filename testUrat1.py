...
#psql = 'select * from public."table_Urat1_test" limit 5;'
...
#df.to_sql('public."table_Urat1_test"', con=pg_engine)
#pg_df = pd.read_sql_query(psql, con=pg_engine)
#print(pg_df)
...
#s = os.path.getsize(dump_file)
#print (s)
>>>>>>> 50814a885c60aa1043388a8458ad92b86754f4bf:testUrat1.py
